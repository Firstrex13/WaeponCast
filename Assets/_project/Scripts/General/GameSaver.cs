...
public class GameSaver : MonoBehaviour
{
    ...
    public PlayerProgress LoadGame()
    {
        ...
        {
            PlayerProgress progress = new PlayerProgress(new CoinCounter(), new PlayerStats(100, 100, 2, 0, 0, 10, 5, 2, 0.1f, 0.5f));
            return progress;
        }
    }
    ...
    public void ResetProgress()
    {
        ...
        {
            YG2.SetDefaultSaves();
            Progress = new PlayerProgress(new CoinCounter(), new PlayerStats(100, 100, 2, 0, 0, 10, 5, 2, 0.1f, 0.5f));
